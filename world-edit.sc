...
base_commands_map = [
    ...
    ['shape cube <pos> <block> <size>', _(pos, block, size_int) -> shape(pos, [block, size_int, null], null), false],
    ['shape cube <pos> <block> <size> f <flag>', _(pos, block, size_int, flags) -> shape(pos, [block, size_int, null], flags), false],
    ['shape cube <pos> <block> <size> <replacement>', _(pos, block, size_int, replacement) -> shape(pos, [block, size_int, replacement], null),
        [2, 'help_cmd_shape_cube', null, null]],
    ['shape cube <pos> <block> <size> <replacement> f <flag>', _(pos, block, size_int, replacement, flags) -> shape(pos, [block, size_int, replacement], flags), false],
    ['shape cuboid <pos> <block> <x_size> <y_size> <z_size>', _(pos, block, x_int, y_int, z_int) -> shape(pos, [block, [x_int, y_int, z_int], null], null), false],
    ['shape cuboid <pos> <block> <x_size> <y_size> <z_size> f <flag>', _(pos, block, x_int, y_int, z_int, flags) -> shape(pos, [block, [x_int, y_int, z_int], null], flags), false],
    ['shape cuboid <pos> <block> <x_size> <y_size> <z_size> <replacement>', _(pos, block, x_int, y_int, z_int, replacement) -> shape(pos, [block, [x_int, y_int, z_int], replacement], null),
        [4, 'help_cmd_brush_cuboid', 'help_cmd_brush_generic', null]],
    ['shape cuboid <pos> <block> <x_size> <y_size> <z_size> <replacement> f <flag>', _(pos, block, x_int, y_int, z_int, replacement, flags) -> shape(pos, [block, [x_int, y_int, z_int], replacement], flags), false],
    ['shape sphere <pos> <block> <radius>', _(pos, block, radius) -> shape(pos, [block, radius, null], null), false],
    ['shape sphere <pos> <block> <radius> f <flag>', _(pos, block, radius, flags) -> shape(pos, [block, radius, null], flags), false],
    ['shape sphere <pos> <block> <radius> <replacement>', _(pos, block, radius, replacement) -> shape(pos, [block, radius, replacement], null),
        [2, 'help_cmd_brush_sphere', 'help_cmd_brush_generic', null]],
    ['shape sphere <pos> <block> <radius> <replacement> f <flag>', _(pos, block, radius, replacement, flags) -> shape(pos, [block, radius, replacement], flags), false],
    ['shape ellipsoid <pos> <block> <x_radius> <y_radius> <z_radius>', _(pos, block, xr, yr, zr) -> shape( pos, [block, [xr, yr, zr], null], null), false],
    ['shape ellipsoid <pos> <block> <x_radius> <y_radius> <z_radius> f <flag>', _(pos, block, xr, yr, zr, flags) -> shape( pos, [block, [xr, yr, zr], null], flags), false],
    ['shape ellipsoid <pos> <block> <x_radius> <y_radius> <z_radius> <replacement>', _(pos, block, xr, yr, zr, replacement) -> shape( pos, [block, [xr, yr, zr], replacement], null),
        [2, 'help_cmd_brush_sphereellipsoid', 'help_cmd_brush_generic', null]],
    ['shape ellipsoid <pos> <block> <x_radius> <y_radius> <z_radius> <replacement> f <flag>', _(pos, block, xr, yr, zr, replacement, flags) -> shape( pos, [block, [xr, yr, zr], replacement], flags), false],
    ['shape cylinder <pos> <block> <radius> <height>', _(pos, block, radius, height) -> shape(pos, [block, radius, height, 'y', null], null), false],
    ['shape cylinder <pos> <block> <radius> <height> f <flag>', _(pos, block, radius, height, flags) -> shape(pos, [block, radius, height, 'y', null], flags), false],
    ['shape cylinder <pos> <block> <radius> <height> <axis>', _(pos, block, radius, height, axis) -> shape(pos, [block, radius, height, axis, null], null), false],
    ['shape cylinder <pos> <block> <radius> <height> <axis> f <flag>', _(pos, block, radius, height, axis, flags) -> shape(pos, [block, radius, height, axis, null], flags), false],
    ['shape cylinder <pos> <block> <radius> <height> <axis> <replacement>', _(pos, block, radius, height, axis, replacement) -> shape(pos, [block, radius, height, axis, replacement], null),
        [2, 'help_cmd_brush_cylinder', 'help_cmd_brush_generic', null]],
    ['shape cylinder <pos> <block> <radius> <height> <axis> <replacement> f <flag>', _(pos, block, radius, height, axis, replacement, flags) -> shape(pos, [block, radius, height, axis, replacement], flags), false],
    ['shape cone <pos> <block> <radius> <height>', _(pos, block, radius, height) -> shape(pos, [block, radius, height, '+y', null], null), false],
    ['shape cone <pos> <block> <radius> <height> f <flag>', _(pos, block, radius, height, flags) -> shape(pos, [block, radius, height, '+y', null], flags), false],
    ['shape cone <pos> <block> <radius> <height> <saxis>', _(pos, block, radius, height, axis) -> shape(pos, [block, radius, height, axis, null], null), false],
    ['shape cone <pos> <block> <radius> <height> <saxis> f <flag>', _(pos, block, radius, height, axis, flags) -> shape(pos, [block, radius, height, axis, null], flags), false],
    ['shape cone <pos> <block> <radius> <height> <saxis> <replacement>', _(pos, block, radius, height, axis, replacement) -> shape(pos, [block, radius, height, axis, replacement], null),
        [2, 'help_cmd_brush_cone', 'help_cmd_brush_generic', null]],
    ['shape cone <pos> <block> <radius> <height> <saxis> <replacement> f <flag>', _(pos, block, radius, height, axis, replacement, flags) -> shape(pos, [block, radius, height, axis, replacement], flags), false],
    ['shape prism_polygon <pos> <block> <radius> <height> <vertices>',
        _(pos, block, radius, height, n_points) -> shape(pos, [block, radius, height, n_points, 'y', 0, null], null), false],
    ['shape prism_polygon <pos> <block> <radius> <height> <vertices> f <flag>',
       _(pos, block, radius, height, n_points, flags) -> shape(pos, [block, radius, height, n_points, 'y', 0, null], flags), false],
    ['shape prism_polygon <pos> <block> <radius> <height> <vertices> <axis>',
       _(pos, block, radius, height, n_points, axis) -> shape(pos, [block, radius, height, n_points, axis, 0, null], null), false],
    ['shape prism_polygon <pos> <block> <radius> <height> <vertices> <axis> f <flag>',
       _(pos, block, radius, height, n_points, axis, flags) -> shape(pos, [block, radius, height, n_points, axis, 0, null], flags), false],
    ['shape prism_polygon <pos> <block> <radius> <height> <vertices> <axis> <degrees>',
       _(pos, block, radius, height, n_points, axis, rotation) -> shape(pos, [block, radius, height, n_points, axis, rotation, null], null), false],
    ['shape prism_polygon <pos> <block> <radius> <height> <vertices> <axis> <degrees> f <flag>',
       _(pos, block, radius, height, n_points, axis, rotation, flags) -> shape(pos, [block, radius, height, n_points, axis, rotation, null], flags), false],
    ['shape prism_polygon <pos> <block> <radius> <height> <vertices> <axis> <degrees> <replacement>',
       _(pos, block, radius, height, n_points, axis, rotation, replacement) ->shape(pos, [block, radius, height, n_points, axis, rotation, replacement], null),
       [4, 'help_cmd_brush_polygon', 'help_cmd_brush_generic', null]],
    ['shape prism_polygon <pos> <block> <radius> <height> <vertices> <axis> <degrees> <replacement> f <flag>',
       _(pos, block, radius, height, n_points, axis, rotation, replacement, flags) -> shape(pos, [block, radius, height, n_points, axis, rotation, replacement], flags), false],
    ['shape prism_star <pos> <block> <outer_radius> <inner_radius> <height> <vertices>',
        _(pos, block, outer_radius, inner_radius, height, n_points) -> shape(pos, [block, outer_radius, inner_radius, height, n_points, 'y', 0, null], null), false],
    ['shape prism_star <pos> <block> <outer_radius> <inner_radius> <height> <vertices> f <flag>',
       _(pos, block, outer_radius, inner_radius, height, n_points, flags) -> shape(pos, [block, outer_radius, inner_radius, height, n_points, 'y', 0, null], flags), false],
    ['shape prism_star <pos> <block> <outer_radius> <inner_radius> <height> <vertices> <axis>',
       _(pos, block, outer_radius, inner_radius, height, n_points, axis) -> shape(pos, [block, outer_radius, inner_radius, height, n_points, axis, 0, null], null), false],
    ['shape prism_star <pos> <block> <outer_radius> <inner_radius> <height> <vertices> <axis> f <flag>',
       _(pos, block, outer_radius, inner_radius, height, n_points, axis, flags) -> shape(pos, [block, outer_radius, inner_radius, height, n_points, axis, 0, null], flags), false],
    ['shape prism_star <pos> <block> <outer_radius> <inner_radius> <height> <vertices> <axis> <degrees>',
       _(pos, block, outer_radius, inner_radius, height, n_points, axis, rotation) -> shape(pos, [block, outer_radius, inner_radius, height, n_points, axis, rotation, null], null), false],
    ['shape prism_star <pos> <block> <outer_radius> <inner_radius> <height> <vertices> <axis> <degrees> f <flag>',
       _(pos, block, outer_radius, inner_radius, height, n_points, axis, rotation, flags) -> shape(pos, [block, outer_radius, inner_radius, height, n_points, axis, rotation, null], flags), false],
    ['shape prism_star <pos> <block> <outer_radius> <inner_radius> <height> <vertices> <axis> <degrees> <replacement>',
       _(pos, block, outer_radius, inner_radius, height, n_points, axis, rotation, replacement) ->shape(pos, [block, outer_radius, inner_radius, height, n_points, axis, rotation, replacement], null),
       [4, 'help_cmd_brush_polygon', 'help_cmd_brush_generic', null]],
    ['shape prism_star <pos> <block> <outer_radius> <inner_radius> <height> <vertices> <axis> <degrees> <replacement> f <flag>',
       _(pos, block, outer_radius, inner_radius, height, n_points, axis, rotation, replacement, flags) -> shape(pos, [block, outer_radius, inner_radius, height, n_points, axis, rotation, replacement], flags), false],
